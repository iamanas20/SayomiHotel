...
@section('content')
<!-- Page Title -->
<div class="page-title parallax parallax1 flat_strech suitesPhoto">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-heading">
                    <h1 class="title">Suites</h1>
            ...
            <div class="col-md-12 flat-tabs ">
                <div class="bg-tabs">
                    <div class="title-section style1 martp-0px">
                        ...
                        <h1 class="title marbt-33px ">All Suites</h1>
                    </div>
                                ...
                                <li>
                                    <div class="media-wrap">
                                        ...
                                        <div class="media-body">
                                            <h6>
                                                <a href="/suite/{{$res->suiteID}}">{{$res->description}}</a>
                                            </h6>
                                            <span>${{$res->pricePerNight}}</span>
                                        </div>
                                        <ul class="menu-in">
                                            <li>Rooms Number</li>
                                            <li>{{$res->numberOfRooms}}</li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
