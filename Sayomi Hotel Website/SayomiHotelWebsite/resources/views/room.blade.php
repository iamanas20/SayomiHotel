        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-heading">
                    <h1 class="title">Book The Room</h1>
...
<section class="flat-row menu-3">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="reservation-page-right">
                    <img src="{{asset('images/'. $roomToBook->url)}}" />
                </div>
            </div><!--col-md-5-->
                    ...
                    <div class="reservation-page-form">
                        ...
                        <div class="title-section">
                            <div id="reserve" class="top-section">
                                <p>Reserve The Room</p>
                            </div>
                            <h1 class="title">
                                {{$roomToBook->description}}
                            </h1>
                            <h4>{{$roomToBook->category}}</h4>
                        </div>
                        ...
                        <form method="get" action="/reservedRoom/{{$roomToBook->roomID}}">
                            ...
                            <div style="margin-top: -20px;" class="reservation-page-input-box">
                                <label>Persons</label>
                                <input type="number" class="form-control" placeholder="6" name="numberOfPersons" id="form-date" data-error="Subject field is required" required="" />
                            </div>
                            <div style="margin-top: -20px;" class="reservation-page-input-box">
                            ...
                            <div class="reservation-booking text-center">
                                <button style="margin-top: 6px;" type="submit" class="book-now-btn">Booking now</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>history.pushState(null, 'Sayomi Hotel', 'http://127.0.0.1:8000/reservedRoom/<?php echo $roomToBook->roomID?>');</script>
        @endif
    </div><!--container -->
</section>
@endsection